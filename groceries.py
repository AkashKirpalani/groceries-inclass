...
sorted_department = sorted(products, key=operator.itemgetter("department"))

def Remove(sorted_department): 
    new_list = [] 
...
department_list = []
department_list = Remove(sorted_department)
...
print("--------------")
print("THERE ARE",count, "DEPARTMENTS")
print("--------------")
